      ...
      <div className="min-h-screen lg:flex lg:justify-center lg:items-start lg:pt-8 lg:pr-20">
        <div className="lg:max-w-4xl lg:w-full">
          ...
          <motion.div
            ...
            className="bg-white rounded-[30px] w-[90%] mx-auto shadow-[5px_5px_5px_5px_rgba(0,0,0,0.1)] lg:w-[95%]"
          >
            {/* Total Balance */}
                        ...
                        >
                          <div className="flex items-center">
                            <div className="p-3 lg:p-4 bg-[#dddddd]/80 rounded-[10px] mr-2 flex items-center justify-center">
                              <h3 className="m-0 text-gray-600 lg:text-xl">
                                {ele.name && ele.name.charAt(0)}
                              </h3>
                            </div>
                            <div>
                              <h5 className="m-0 text-left text-black font-medium lg:text-lg">
                                {ele.name}
                              </h5>
